      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-8">
          <div className="mb-12">
            ...
            <p className="text-body-lg text-text-muted max-w-xl">
              Book a discovery call to discuss your current workflow and how we can scale your asset output without babysitting the timeline.
            </p>
          </div>

          <div className="pt-4">
            <a href="https://calendly.com" target="_blank" rel="noopener noreferrer" className="btn-primary w-full md:w-auto flex justify-center items-center group max-w-md">
              Book via Calendly
        ...
        <div className="lg:col-span-4 flex flex-col gap-16 lg:pl-12 lg:border-l border-border/50">
          ...
          <div>
            ...
            <a href="mailto:hello@cedcantong.com" className="heading-md hover:text-primary transition-colors break-words block mb-4">
              hello@<br/>cedcantong.com
            </a>
          ...
          <div>
            ...
            <div className="flex flex-col gap-6">
              <a href="#" className="heading-md flex items-center justify-between group hover:text-primary transition-colors">
                Instagram
