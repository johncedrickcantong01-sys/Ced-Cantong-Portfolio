      ...
      <div className="container-max py-12 flex flex-col md:flex-row justify-between items-end gap-8">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-8 items-center">
          <div className="flex gap-4 text-[11px] font-medium uppercase text-text-main font-sans tracking-widest">
            <a href="#" className="opacity-40 hover:opacity-100 transition-opacity">IG</a>
            <a href="#" className="opacity-40 hover:opacity-100 transition-opacity">LI</a>
            <a href="#" className="opacity-40 hover:opacity-100 transition-opacity">TW</a>
          </div>
        </div>
